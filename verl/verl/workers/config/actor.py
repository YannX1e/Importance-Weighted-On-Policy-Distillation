...
class PolicyLossConfig(BaseConfig):
    ...
    Args:
        ...
        lambda_vals (float): Lambda coefficient for on-policy distillation.
            Standard OPD and IW-OPD use lambda_vals=1.0.
    """
    ...
    opd_prefix_weight_enable: bool = False
    opd_prefix_weight_start_ratio: float = 0.3
    opd_prefix_weight_end_ratio: float = 1.0
    opd_prefix_weight_schedule: str = "cosine"
    opd_prefix_weight_multiplier: float = 1.5
    opd_prefix_weight_min_tokens: int = 1
    iw_opd_weight_enable: bool = False
    iw_opd_weight_max: float = 1.5
    iw_opd_weight_use_abs: bool = True
    opd_prefix_mask_enable: bool = False
    opd_prefix_mask_start_ratio: float = 0.3
    opd_prefix_mask_end_ratio: float = 1.0
    opd_prefix_mask_schedule: str = "cosine"
    opd_prefix_mask_min_tokens: int = 1
    teacher_prefix_conf_weight: bool = False
    teacher_prefix_conf_window: int = 64
    teacher_prefix_conf_quantile: float = 0.9
    teacher_prefix_conf_alpha: float = 1.0
    teacher_prefix_conf_weight_min: float = 0.0
